...
// ===================================
// STEP 2: LABS 1-2 FOUNDATION ASSUMED
// ===================================
// This lab builds on Labs 1-2 - entities from previous labs are assumed to exist
// Policies and other entities from Lab 2 will be referenced via MATCH when needed
...
// ===================================
// STEP 8: CREATE LAB 3 RELATIONSHIPS
// ===================================
// Note: Customer-Policy-Agent relationships already exist from Lab 2
// Only creating NEW relationships introduced in Lab 3

// Asset coverage relationships (NEW in Lab 3)
...
// Add more payments to meet test requirements (need at least 3 payments total)
CREATE (payment2:Payment {
  id: randomUUID(),
  payment_id: "PAY-001235",
  policy_number: "POL-AUTO-001235",
  payment_type: "Premium",
  amount: 125.00,
  payment_date: date("2024-07-15"),
  payment_method: "Credit Card",
  payment_status: "Processed",
  transaction_id: "TXN-789013",
  confirmation_number: "CONF-789013",
  billing_period: "2024-07",
  created_at: datetime(),
  created_by: "billing_system",
  version: 1
...
// Add more invoices to meet test requirements (need at least 2 invoices total)
...
// Create relationships for new payment and invoice
MATCH (michael:Customer {customer_number: "CUST-001235"})
MATCH (michael_home:Policy {policy_number: "POL-HOME-001235"})
MATCH (payment2:Payment {payment_id: "PAY-001235"})
MATCH (invoice2:Invoice {invoice_number: "INV-2024-001235"})
MATCH (emma:Customer {customer_number: "CUST-001236"})
MATCH (settlement1:Payment {payment_id: "PAY-SETT-001"})
CREATE (michael)-[:MADE_PAYMENT {payment_date: date("2024-07-15"), payment_channel: "Credit Card", created_at: datetime()}]->(payment2)
CREATE (payment2)-[:APPLIED_TO {application_date: date("2024-07-15"), amount_applied: 95.00, remaining_balance: 0.00, created_at: datetime()}]->(michael_home)
CREATE (emma)-[:RECEIVED_SETTLEMENT {received_date: date("2024-07-10"), settlement_amount: 3200.00, created_at: datetime()}]->(settlement1);

// Add third payment for Emma to ensure we have 3+ payments
CREATE (payment3:Payment {
  id: randomUUID(),
  payment_id: "PAY-001236",
  policy_number: "POL-AUTO-001236",
  payment_type: "Premium",
  amount: 130.00,
  payment_date: date("2024-07-20"),
  payment_method: "Bank Transfer",
  payment_status: "Processed",
  transaction_id: "TXN-789014",
  confirmation_number: "CONF-789014",
  billing_period: "2024-07",
  created_at: datetime(),
  created_by: "billing_system",
  version: 1
...
MATCH (emma:Customer {customer_number: "CUST-001236"})
MATCH (emma_auto:Policy {policy_number: "POL-AUTO-001236"})
MATCH (payment3:Payment {payment_id: "PAY-001236"})
CREATE (emma)-[:MADE_PAYMENT {payment_date: date("2024-07-20"), payment_channel: "Bank Transfer", created_at: datetime()}]->(payment3)
CREATE (payment3)-[:APPLIED_TO {application_date: date("2024-07-20"), amount_applied: 130.00, remaining_balance: 0.00, created_at: datetime()}]->(emma_auto);
...
// Expected result after Lab 3: 29 nodes, 30 relationships
// (Labs 1-2: 16 nodes + Lab 3: 13 nodes = 29 nodes)
// (Labs 1-2: 14 relationships + Lab 3: 16 relationships = 30 relationships)